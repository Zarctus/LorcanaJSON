...
DEFAULT_ICONIC_PARSE_SETTINGS = ParseSettings(labelParsingMethod=LABEL_PARSING_METHODS.FALLBACK_COLOR_FILTER, textboxLeftOffset=-20, textboxRightOffset=60)
DEFAULT_STANDARDSIZED_ICONIC_PARSE_SETTINGS = dataclasses.replace(DEFAULT_ICONIC_PARSE_SETTINGS, characterCardLayout=CardLayout.ICONIC_CHARACTER)
