...
NEW_ENCHANTED_SMALL_TEXTBOX = CardLayout(IA.NEW_ENCHANTED_CARD_NAME, IA.NEW_ENCHANTED_TYPE_SMALL_TEXT_BOX, IA.NEW_ENCHANTED_FULL_WIDTH_SMALL_TEXT_BOX)
NEW_ENCHANTED_CHARACTER_SMALL_TEXTBOX = CardLayout(IA.NEW_ENCHANTED_CARD_NAME, IA.NEW_ENCHANTED_TYPE_SMALL_TEXT_BOX, IA.NEW_ENCHANTED_CHARACTER_SMALL_TEXT_BOX, IA.NEW_ENCHANTED_VERSION, IA.STRENGTH, IA.WILLPOWER)

ICONIC_CHARACTER = dataclasses.replace(DEFAULT_CHARACTER, textbox=IA.ICONIC_CHARACTER_TEXT_BOX, types=IA.ICONIC_TYPE)
