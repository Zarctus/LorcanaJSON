...
ENCHANTED_CHARACTER_TEXT_BOX = ImageArea("textbox", "Enchanted Character Text Box", _Coords(36,1394,  1309,1901), TEXT_COLOUR_MIDDLE)
...
ARTIST = ImageArea("artist", "Artist", _Coords(109, 1925, 652, 1969), TEXT_COLOUR_WHITE)
...
NEW_ENCHANTED_FULL_WIDTH_TEXT_BOX = ImageArea("newEnchantedFullWidthTextbox", "New Enchanted Full Width Textbox", _Coords(134,1404, 1375,1850), TEXT_COLOUR_WHITE)
